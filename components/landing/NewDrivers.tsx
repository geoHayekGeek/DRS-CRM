    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-end mb-12 border-b border-gray-100 pb-6">
          <div>
            <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">New Legends</h2>
          </div>
          <Link
            href="/drivers"
        ...
        {/* Grid Section */}
        {list.length === 0 ? (
          <p className="text-gray-500 text-center py-12">No drivers yet</p>
        ) : (

      ...
      <div className="min-h-screen bg-white pb-24">
        <div className="bg-gray-900 text-white pt-12 pb-20 px-4">
          <div className="max-w-7xl mx-auto">
            <Link
              href="/landing"
              className="inline-flex items-center gap-2 text-gray-400 font-bold uppercase tracking-widest text-xs hover:text-white transition-colors"
            >
              <FaArrowLeft /> Back to Home
            </Link>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 flex flex-col items-center justify-center py-32">

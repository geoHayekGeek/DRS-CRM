              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full px-3 py-3 pr-12 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 disabled:bg-gray-50 disabled:cursor-not-allowed"
                    style={{ 
                      '--tw-ring-color': theme.colors.primary.red 
                    } as React.CSSProperties & { '--tw-ring-color': string }}
                    onFocus={(e) => e.currentTarget.style.boxShadow = `0 0 0 2px ${theme.colors.primary.red}`}
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 rounded"
